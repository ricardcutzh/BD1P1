    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img class="user-avatar rounded-circle" src="{{ asset('imgs/adm.png')}}" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Usuarios en El Sistema</h3><!-- /.menu-title -->
                    ...
                    <h3 class="menu-title">Zonas En El Sistema</h3><!-- /.menu-title -->
                    ...
                    <h3 class="menu-title">Informacion de ELecciones</h3><!-- /.menu-title -->
                    ...
                    <h3 class="menu-title">Catalogos</h3><!-- /.menu-title -->
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('imgs/usua.jpg')}}" alt="User Avatar">
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                                ...
                                <a class="nav-link" href="{{ route('main') }}"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
