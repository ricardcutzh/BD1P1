...
@section('path_pag')
  ...
  <li class="active">Ver Departamentos</li>
@endsection
            ...
            <tbody>
              @foreach ($departamentos as $departamento)
                <tr>
                  ...
                  <td><a href="{{ route('editar_departamento',['pais'=>$departamento->ID_DEPARTAMENTO])}}" class="btn btn-warning mb-1" value=""><li class="fa fa-magic"></li> Editar</a></td>
                  <form action="{{ route('delete_departamento',['pais'=>$departamento->ID_DEPARTAMENTO])}}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
